const Footer = () => {
    return (
        <section className="py-10 w-full bg-white-50 sm:pt-16 lg:pt-24">
            <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 w-full">
                <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
                    <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                        <img className="w-auto h-9" src="https://cdn.rareblocks.xyz/collection/celebration/images/logo.svg" alt="" loading="lazy" decoding="async" />

                        <p className="text-base leading-relaxed text-gray-600 mt-7">Very aggressive design</p>
                    ...
                    <div className="col-span-2 md:col-span-1 lg:col-span-2 lg:pl-8">
                        ...
                        <form action="#" method="POST" className="mt-6">
                            <div>
                                <label id="email" className="sr-only">Email</label>
                            ...
                            {/* <button type="submit" className="inline-flex items-center justify-center px-6 py-4 mt-3 font-semibold text-black transition-all duration-200 bg-blue-600 rounded-md hover:bg-blue-700 focus:bg-blue-700">Subscribe</button> */}
                        </form>
                    </div>
                </div>
